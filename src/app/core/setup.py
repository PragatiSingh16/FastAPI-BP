...
def create_application(router: APIRouter) -> FastAPI:
    """
    Creates and configures a FastAPI application with the provided router.
    ...
    -------
    FastAPI
        A fully configured FastAPI application instance with the specified router.

    This simplified function only takes a router parameter and initializes a FastAPI application
    with the provided router. No additional settings or configurations are applied.
    """
    application = FastAPI()
    application.include_router(router)

    # Add CORS middleware (you can customize origins as needed)
